    ...
    <section className="flex flex-col justify-start items-center bg-[#f5f2ea] pb-12">
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center w-full sm:p-12 gap-8">
        {pricesData.map((service, index) => (
          <div
            key={index}
            className="relative w-52 sm:w-64 flex flex-col justify-center items-center border-[#BF925B] mb-4 sm:mb-0
          ...
          >
            ...
            <button className="w-36 h-12 absolute -bottom-6 left-1/2 -translate-x-1/2 bg-[#BF925B] text-black 
